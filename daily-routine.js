...
const STORAGE_KEY='dahlman_daily_routine_oslo_v2';
...
function buildWidget(){
 ...
 card.insertAdjacentHTML('beforeend','<div class="daily-routine-v2-progress"><i id="dailyRoutineV2Progress"></i></div><div id="dailyRoutineV2List" class="daily-routine-v2-list"></div><div class="daily-routine-v2-date">Resets at midnight · Norway time</div>');
 return true;
}
