...
function ensureHead(){
 ...
 upsert('icon','/assets/dahlmans-logo-192.png?v=8','image/png');
 upsert('apple-touch-icon','/assets/dahlmans-logo-192.png?v=8');
 upsert('manifest','/manifest.json?v=8');
}
...
function apply(){ensureHead();ensureDaily();brand();ensureCarousel();mobileMenu();equalBudget();removeDuplicateNav()}
