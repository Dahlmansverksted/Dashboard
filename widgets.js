...
(async()=>{await script('/public-sync.js?v=20');ensureRenderTargets();await script('/dashboard-unified.js?v=20');ensureRenderTargets();await script('/goals.js?v=20');ensureRenderTargets();await script('/dashboard-fixes.js?v=20');ensureRenderTargets()})();
})();