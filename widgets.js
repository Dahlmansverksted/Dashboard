...
(async()=>{
 try{
  await script('/public-sync.js?v=27');ensureRenderTargets();
  await script('/dashboard-unified.js?v=27');ensureRenderTargets();
  await script('/goals.js?v=27');ensureRenderTargets();
  await script('/dashboard-fixes.js?v=27');ensureRenderTargets();
  await script('/daily-routine.js?v=27');ensureRenderTargets();
