...
(async()=>{
 try{
  await script('/public-sync.js?v=22');ensureRenderTargets();
  await script('/dashboard-unified.js?v=22');ensureRenderTargets();
  await script('/goals.js?v=22');ensureRenderTargets();
  await script('/dashboard-fixes.js?v=22');ensureRenderTargets();
