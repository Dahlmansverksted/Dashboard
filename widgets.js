...
(async()=>{
 try{
  await script('/public-sync.js?v=26');ensureRenderTargets();
  await script('/dashboard-unified.js?v=26');ensureRenderTargets();
  await script('/goals.js?v=26');ensureRenderTargets();
  await script('/dashboard-fixes.js?v=26');ensureRenderTargets();
  await script('/daily-routine.js?v=26');ensureRenderTargets();
